		...
		<table>
			...
			<tr>
				...
				<c:forEach items="${cityList}" var="city">
							<option value="<c:out value="${city.state_id}" />"><c:out value="${city.state_id.description}" /></option>
				</c:forEach>
				</select>
				</td>
				
				<!-- <td><form:select path="state_id">
						<form:option value="NONE" label="--- States ---" />		
						<form:option value="${state.description}"/>
					</form:select></td><td><form:errors path="description" cssClass="error" /></td> -->
